...
import { FINISH_LEVEL, VARIANT_NAMES, effectiveRun, markNameIn, requestable } from "../ladder.mjs";
...
function waitingOn(mark, token, catalogue) {
  ...
  if (mark.needsWhole && token.level < FINISH_LEVEL) return `a whole heart, ${FINISH_LEVEL} days`;
