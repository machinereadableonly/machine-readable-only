...
///
/// Only five of the seven draw. Pulse is an `animation_url` and Singularity
/// chooses the QArt target picture at mint, so both are recorded in the
/// attributes and change nothing about what is drawn.
///
...
/// four of the five Marks are a substituted string and nothing more. Measured at
/// the ring cap, all five together cost about 5,000 gas and 206 bytes.
///
